...
var default_kwh_ods_nt_cijena = 0.17;
...
'opis': [
	...
	'HEP ODS - jednotarifno brojilo - cijena za prijenos i distribuciju 1 kWh (JT: 0-24h)',
	'HEP ODS - dvotarifno brojilo - cijena za prijenos i distribuciju 1 kWh u višoj tarifi (VT: od 7-21h zimi, 8-22h ljeti)',
	'HEP ODS - dvotarifno brojilo - cijena za prijenos i distribuciju 1 kWh u nižoj tarifi (NT: od 21-7h zimi, 22-8h ljeti)',
...
{       'naziv': 'HEP Elektra - Univerzalna usluga (default)',
	...
	'kwh_ods_prijenos_jt_cijena': default_kwh_ods_jt_cijena,
	'kwh_ods_prijenos_vt_cijena': default_kwh_ods_vt_cijena,
	'kwh_ods_prijenos_nt_cijena': default_kwh_ods_nt_cijena,
...
{       'naziv': 'HEP Opskrba - HEPI',
	...
	'notes': 'FIXME - samoocitanje - bez naknade za opskrbu? FIXME - dodatni popusti za HEPI club?',
},
...
{       'naziv': 'RWE - IDEAL 3 godine (A-10%)',
	'kwh_jt_cijena': HEP_univerzalna_jt_cijena * (1-0.1),
	'kwh_vt_cijena': HEP_univerzalna_vt_cijena * (1-0.1),
	'kwh_nt_cijena': HEP_univerzalna_nt_cijena * (1-0.1),
	'kwh_ods_prijenos_jt_cijena': default_kwh_ods_jt_cijena,
	'kwh_ods_prijenos_vt_cijena': default_kwh_ods_vt_cijena,
	'kwh_ods_prijenos_nt_cijena': default_kwh_ods_nt_cijena,
	'mj_naknada_omm': default_naknada_omm,
